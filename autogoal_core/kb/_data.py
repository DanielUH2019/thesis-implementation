from autogoal_core.exceptions import InterfaceIncompatibleError
...
from autogoal_core.grammar import Symbol, Union, Empty, Subset
...
# #     from autogoal_core.kb._algorithm import _get_annotations
